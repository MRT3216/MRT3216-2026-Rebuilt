...
public final class Constants {
    ...
    public static final class TurretConstants {
        ...
        /** X offset (inches) from robot origin to turret pivot. */
        public static final Distance kTurretOffsetX = Inches.of(0.0);

        /** Y offset (inches) from robot origin to turret pivot. */
        public static final Distance kTurretOffsetY = Inches.of(0.0);

        /** Z offset (inches) from floor to turret pivot height. */
    ...
    public static final class SpindexerConstants {
        ...
        // Effective gear reduction from motor to roller (motor rotations per roller
        // rotation)
        public static final double kGearing = 5.0;
        /** Backwards-compatible name used by some subsystems. */
        public static final double kGearReduction = kGearing;

        // Physical constants for the spindexer wheel
        /** Diameter of the spindexer wheel. */
        public static final Distance kWheelDiameter = Inches.of(2);

        /** Mass of the spindexer wheel. */
        public static final Mass kWheelMass = Pounds.of(1);
        // Motor inversion
        public static final boolean kMotorInverted = false;
    ...
    // Controls whether the HAL (Hardware Abstraction Layer) should be disabled for
    // special execution modes (tests, static analysis). Make the backing field
    // private and provide explicit setters/getters for clarity.
    private static boolean disableHAL = false;

    /** Convenience: set disableHAL to true. */
    public static void setDisableHAL() {
        setDisableHAL(true);
    }

    /** Set or clear the HAL-disable flag. */
    public static void setDisableHAL(boolean disable) {
        disableHAL = disable;
    }

    /** Query whether HAL is disabled. */
